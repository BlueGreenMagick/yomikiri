...
import { type AnkiTemplate, type AnkiTemplateField, type Field, type AnkiTemplateFieldSentenceOptions, type AnkiTemplateFieldWordOptions, type AnkiNote, newAnkiTemplateField } from "lib/anki";
...
export function migrateConfiguration_2(config: StoredConfig<Configuration_2>): StoredConfig<Configuration> {
  const newConfig = {
    ...config,
    config_version: 3
