...
*/
export type Configuration_1_Conf = Pick<Configuration,
  "state.enabled"
  | "general.font_size"
  | "general.font"
  | "anki.connect_port"
...
export type Configuration_1 = Configuration_1_Conf & { config_version?: undefined }

export function migrateConfiguration_1(config: StoredConfig<Configuration_1>): StoredConfig<Configuration_2> {
  return {
    ...config,
    config_version: 2
  }
